...
module.exports = (data, coord) => {
  ...
  if (data.ActivityStartDate) {
    ...
    if (isValidDate(`${data.ActivityStartDate}T${data.ActivityStartTime}`)) {
      ActivityStartTimestamp = formatISO(toDate(`${data.ActivityStartDate}T${data.ActivityStartTime}`,dateOptions), dateOptions)
  ...
  if (data.ActivityEndDate) {
    ...
    if (isValidDate(`${data.ActivityEndDate}T${data.ActivityEndTime}`)) {
      ActivityEndTimestamp = formatISO(toDate(`${data.ActivityEndDate}T${data.ActivityEndTime}`,dateOptions), dateOptions)
