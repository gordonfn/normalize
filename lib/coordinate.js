...
proj4.defs([
  ...
  [
    'EPSG:4957',
    '+proj=longlat +ellps=GRS80 +towgs84=-0.991,1.9072,0.5129,0.0257899075194932,-0.009650098960270402,-0.011659943232342112,0.0 +no_defs'
  ]
])
...
module.exports = (first, coord, round = 6) =>
  proj4(first, 'EPSG:4326', coord).map(
